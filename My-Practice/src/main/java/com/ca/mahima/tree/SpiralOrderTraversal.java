...
//        tree_level.root.right.left = new Node(12);
        tree_level.root = new Node(9);
        tree_level.root.left = new Node(8);
        tree_level.root.right = new Node(11);
        tree_level.root.left.left = new Node(4);
        tree_level.root.left.left.left = new Node(3);
        tree_level.root.left.left.left.left = new Node(2);
        tree_level.root.left.left.left.right = new Node(7);
        tree_level.root.left.left.left.left.left = new Node(1);
        tree_level.root.left.left.left.left.left.left = new Node(0);
        tree_level.root.left.left.left.right.left = new Node(6);
        tree_level.root.left.left.left.right.left.left = new Node(5);
        tree_level.root.right.left = new Node(10);
        tree_level.root.right.right = new Node(12);
